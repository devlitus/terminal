# PreToolUse hook for the Architect agent.
# Denies any attempt to edit a .go source file.
# The Architect describes contracts and responsibilities — it does not write implementation code.
        ...
        if ($filePath -match '\.go$') {
            @{
                hookSpecificOutput = @{
                    ...
                    permissionDecisionReason = "Architect agent does not write implementation code. '$filePath' is a Go source file — describe the contract or interface instead, and let Code Expert handle the implementation."
                }
